/*
 * Circular Gallery de reactbits (fuente oficial ts-tailwind,
 * DavidHDev/react-bits) — vitrina WebGL de imágenes en arco, con arrastre y
 * flechas. Adaptaciones mínimas: export nombrado, la tipografía de la marca
 * (Montserrat ya cargada por la app, sin fontUrl) y nada más; el resto es el
 * código oficial tal cual para poder actualizarlo por diff.
 */
/* eslint-disable */
// @ts-nocheck -- archivo vendoreado tal cual de reactbits; se actualiza por diff, no se endurece.
