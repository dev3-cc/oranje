        ...
        {cells.map((date, index) => {
          if (date === null) {
            return (
              <div
                ...
                className={cn(
                  'min-h-16 border-t border-l border-line bg-surface-2/50',
          ...
          return (
            <button
              ...
              className={cn(
                'flex min-h-16 flex-col items-start gap-1 border-t border-l border-line p-2 text-left',
              ...
              {aggregate !== undefined && (
                <>
                  <span className="text-xs font-bold text-ink">
                    ...
                    <span className="ml-1 font-normal text-ink-3">· {aggregate.people} pers.</span>
                  </span>
